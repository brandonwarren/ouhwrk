"""
Django settings for ouchallenge project.
...
SECRET_KEY = '43b@w(gh^p-ycc#qwsfwfsvz!wut211o-5^j^9(m4+h82f_pj4'
...
# use local-memory caching for now
CACHES = {
    'default': {
...
WSGI_APPLICATION = 'ouchallenge.wsgi.application'
